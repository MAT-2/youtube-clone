...
//Exporting logo URL for site
export const logo =
  "https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Trifuerza.svg/800px-Trifuerza.svg.png";

//Exporting the array of categories to use for sidebar.
export const categories = [
  { name: "New", icon: <HomeIcon /> },
  { name: "Triforce Odyssey", icon: <CodeIcon /> },
...
export const demoChannelTitle = "Triforce Odyssey";
